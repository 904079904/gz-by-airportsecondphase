import * as material from "./FreightWorldData.js";
import "echarts/map/js/world.js";

class FreightWorldMap extends Component {
  constructor(props) {
    super(props);
    this.state = {
      effect1: {
  ...
  _drawChart(fltData) {
    ...
    let myChart = echarts.init(document.getElementById("FreightWorldMap"));
  ...
  render() {
    return <div id={"FreightWorldMap"}></div>;
  }
}
FreightWorldMap.propTypes = {
  fltData:PropTypes.array.isRequired,
};
FreightWorldMap.defaultProps = {
  
};
export default FreightWorldMap;
